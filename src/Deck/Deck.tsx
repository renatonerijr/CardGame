...
function Deck() {
    ...
    const { setDeckViewer } = gameLogic.deck
    ...
    return (
        ...
        >
            ...
            <div className='flex-row'>
                ...
                <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 w-full border border-blue-700 rounded" onClick={() => {setDeckViewer(true)}}>See deck</button>
