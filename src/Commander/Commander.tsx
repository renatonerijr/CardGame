...
export const Commander = () => {
    ...
    const addLifeToStorage = () => {
        ...
        filteredSession['life'] = filteredSession['life'] + 1
    ...
    return (
        <div className='mb-10'>
            ...
            <div className="w-full flex-row mt-2 space-x-2 flex">
                <button className="bg-blue-500 w-full hover:bg-blue-700 text-white font-bold py-2 px-4 border border-blue-700 rounded" onClick={() => {addLifeToStorage()}}>+1</button>
                <button className="bg-blue-500 w-full hover:bg-blue-700 text-white font-bold py-2 px-4 border border-blue-700 rounded" onClick={() => {removeLifeToStorage()}}>-1</button>
            </div>
        </div>
    )
}